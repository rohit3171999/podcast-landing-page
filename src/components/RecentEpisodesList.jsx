...
//
//
// export default function RecentEpisodesList({episodeID, episodeLink, episodeDescription, episodeTitle, imageURL, episodeDuration}) {
//   return (
    ...
    return (
        <div className="bg-gray-900 py-16 sm:py-20">
            <div className="container mx-auto px-6">
                ...
                <article className="flex flex-col md:flex-row bg-gray-800 rounded-lg overflow-hidden shadow-lg">
                    <div className="md:w-1/3">
                        <img
                            className="w-full h-48 md:h-full object-cover"
                            src={imageURL}
              ...
              <span className="text-gray-500 font-medium">
                {episodeDuration}
                            ...
                            <a
                                href={episodeLink}
                                className="bg-indigo-600 hover:bg-indigo-700 text-white font-semibold py-2 px-5 rounded-full text-sm transition duration-300 ease-in-out transform hover:scale-105"
                            >
                                Play
                            </a>
                        </div>
